...
conn_str = os.environ["IOTHUB_CONNECTION_STR_KITCHEN"]
...
if __name__ == "__main__":
    ...
    for i in range(1, 11):
        ...
        device_state = recorder.get_deviceState("H5111", "74:E3:E1:3D:04:C6:16:84")
        ...
        message = Message( f'{{"messageIndex": "{i}", "temperature": {value}, "device":"Ras5-Kitchen Freezer"}}' )
